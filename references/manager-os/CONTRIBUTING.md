# Contributing to Manager Operating System
...
Before committing any change to MOS template files, commands, or structure:
...
### Migration Steps
1. Add §14 to `01_KERNEL/manager_operating_system.md` after §13
2. Update `03_DRIVERS/team_operating_system.md` §6 header from "Strategic Translation" to "Strategic Alignment"
```
